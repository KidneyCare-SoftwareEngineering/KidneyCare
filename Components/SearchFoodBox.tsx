'use client'
const SearchFoodBox: React.FC <> = () => {
    return(
        <>
            <div className="flex justify-center rounded-xl bg-white w-11/12 h-full drop-shadow-lg  p-2">
                <div 
                ...
                <div className="flex w-3/5 h-full flex-col p-2"> 
                    <div className="flex w-full justify-between items-center mb-2">
                        <div className="justify-start text-body1 font-extrabold">สลัดอกไก่ย่าง</div>
                        <div className="justify-end text-searchcalories text-body3 font-extrabold">150 แคลอรี่</div>
                    </div>
                    ...
                    <div className="flex w-full justify-center items-center">
                        ...
                        <div className="flex w-1/5 h-full justify-end">
                            <p className="text-black text-body3">13</p>
                    ...
                    <div className="flex w-full justify-center items-center">
                        ...
                        <div className="flex w-1/5 h-full justify-end">
                            <p className="text-black text-body3">4</p>
                            <p className="text-gray300 text-body3 ml-1"> ก. </p>
                        </div>
                    </div>
