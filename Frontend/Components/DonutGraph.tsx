        ...
        <div className="flex w-full h-fit bg-white mt-2 px-3 justify-center items-center">
            ...
            <div className="flex w-full pl-2 flex-col">
                ...
                <div className="flex w-full h-8 justify-center items-center ">
                    ...
                    <div className="flex w-3/12 justify-center items-center line-clamp-1">{food.protein} ก.</div>
                </div>
                ...
                <div className="flex w-full h-8 justify-center items-center ">
                    ...
                    <div className="flex w-3/12 justify-center items-center line-clamp-1">{food.carbs} ก.</div>
                </div>
                ...
                <div className="flex w-full h-8 justify-center items-center ">
                    ...
                    <div className="flex w-3/12 justify-center items-center line-clamp-1">{food.fat} ก.</div>
                </div>
                ...
                <div className="flex w-full h-8 justify-center items-center ">
                    ...
                    <div className="flex w-3/12 justify-center items-center line-clamp-1">{food.sodium} ก.</div>
                </div>
                ...
                <div className="flex w-full h-8 justify-center items-center ">
                    ...
                    <div className="flex w-3/12 justify-center items-center line-clamp-1">{food.phosphorus} ก.</div>
                </div>
                ...
                <div className="flex w-full h-8 justify-center items-center ">
                    ...
                    <div className="flex w-3/12 justify-center items-center line-clamp-1">{food.potassium} ก.</div>
                </div>
                ...
                {/* <div className="flex w-full h-8 justify-center items-center ">
                    ...
                    <div className="flex w-3/12 justify-center items-center line-clamp-1">{food.} ก.</div>
                </div> */}
            </div>
        </div>
    </>
